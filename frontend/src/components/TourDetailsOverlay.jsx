      ...
      <div className="glass max-w-7xl w-full rounded-3xl overflow-hidden flex flex-col md:flex-row h-full max-h-[85vh] shadow-2xl relative border border-white/5">
          ...
          <div className="grid grid-cols-2 md:grid-cols-1 gap-3 p-1">
            {imagenes.map((img, idx) => (
              <div
                ...
                className="relative aspect-square rounded-2xl overflow-hidden group border border-[#2b2b46]/50 cursor-pointer shadow-md hover:scale-[1.12] hover:z-30 hover:shadow-[0_20px_50px_rgba(233,69,96,0.3)] hover:border-[#e94560]/50 transition-all duration-300 ease-out"
              >
                <img
        ...
        <div className="w-full md:w-[45%] lg:w-[48%] p-6 md:p-8 flex flex-col justify-between overflow-y-auto border-b md:border-b-0 md:border-r border-[#2b2b46]/50 h-full no-scrollbar">
          <div className="space-y-6">
            ...
            {hasVariants && (
              <div className="bg-[#121224]/50 border border-[#2b2b46]/40 p-4 rounded-2xl space-y-2.5">
                      ...
                      <button
                        ...
                        className={`px-4 py-2 rounded-xl text-xs font-bold transition-all duration-300 ${
                          isSelected
                            ...
                            : 'bg-[#16162a] hover:bg-[#2b2b46]/50 text-gray-400 hover:text-white border border-[#2b2b46]'
                        }`}
                      >
          ...
          <div className="pt-6 space-y-4">
            <div className="bg-[#121224] border border-[#2b2b46]/50 p-4 rounded-2xl flex justify-between items-center text-sm">
              ...
              <div className="text-right">
                ...
                <span className="text-xs bg-[#e94560]/10 text-[#e94560] px-2.5 py-0.5 rounded-full font-bold">
                  {displayCupos} libres
                </span>
              </div>
            </div>
