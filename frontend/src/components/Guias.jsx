...
export default function Guias() {
  ...
  return (
    <section
      id="guias"
      className="min-h-screen py-10 md:py-14 lg:py-8 px-4 sm:px-6 flex flex-col justify-center border-t border-white/10 relative overflow-hidden scroll-mt-14 bg-[#090a10]"
    >
