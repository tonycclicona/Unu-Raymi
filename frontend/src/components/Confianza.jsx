...
export default function Confianza() {
  ...
  return (
    <section id="reviews" className="py-16 md:py-24 px-6 flex items-center bg-[var(--background)] border-t border-[var(--border)]/30 relative overflow-hidden scroll-mt-[52px] md:scroll-mt-[58px]">
      {/* Luz ambiental */}
